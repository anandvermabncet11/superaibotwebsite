...
function FundTransferToToupWallet() {
  ...
  async function sendTokenTransaction() {
    if (!fk.values.transfer_amount || Number(fk.values.transfer_amount) <= 0) {
    ...
    if (Number(user_profile?.tr03_fund_wallet || 0) < Number(fk.values.transfer_amount || 0)) {
    ...
    try {
      const payload = {
        ...
        pkg_id: 1,
        to_customer_id: fk.values.customer_id,
      ...
      if (res?.data?.success) {
        ...
        fk.handleReset();
        navigate("/fund-transfer-to-topup-wallet");
      } else {
            ...
            <div className="mb-6">
              ...
              <div className="relative mb-4">
                <input
                  ...
                  className="w-full px-4 py-3 rounded-lg bg-gradient-to-r from-cyan-950/40 to-blue-900/30 text-cyan-300 text-sm border border-cyan-400/20 font-semibold"
                />
              </div>
              ...
              <input
                ...
                onChange={fk.handleChange}
                className="w-full px-4 py-3 rounded-lg bg-gradient-to-r from-blue-950/40 to-indigo-900/30 text-white text-lg border-2 border-blue-400/30 focus:border-blue-400 focus:outline-none transition-all duration-300 font-semibold mb-4"
              />
              ...
              <div className="flex flex-col mb-2">
                <input
                  ...
                  onChange={fk.handleChange}
                  className="w-full px-4 py-3 rounded-lg bg-gradient-to-r from-blue-950/40 to-indigo-900/30 text-white text-lg border-2 border-blue-400/30 focus:border-blue-400 focus:outline-none transition-all duration-300 font-semibold "
                />
              ...
              <button
                // onClick={() => areYouSureFn(Swal, sendTokenTransaction)}
