    ...
    const sections = [
        {
            ...
            content: "By accessing and using Trade4you (\"the Platform\"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service."
        },
        {
            title: "2. Description of Service",
            content: "Trade4you provides an AI-powered automated trading platform that allows users to create, configure, and deploy trading bots for various financial markets including Currency, Cryptocurrencies, Commodities, and Stock Indices. Our platform includes backtesting capabilities, risk management tools, and automated trading execution."
        },
        {
        ...
        },
        {
            ...
            content: "All content, features, and functionality of the Platform, including but not limited to text, graphics, logos, icons, images, audio clips, digital downloads, and software, are the exclusive property of Trade4you and are protected by international copyright, trademark, and other intellectual property laws."
        },
        {
            title: "8. Limitation of Liability",
            content: "To the maximum extent permitted by law, Trade4you shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, or any loss of data, use, goodwill, or other intangible losses resulting from your use of the Platform."
        },
        {
            title: "9. Indemnification",
            content: "You agree to indemnify and hold harmless Trade4you, its officers, directors, employees, and agents from any claims, damages, losses, liabilities, and expenses (including legal fees) arising out of your use of the Platform or violation of these Terms."
        },
        {
        ...
        },
        {
            ...
            content: "If you have any questions about these Terms, please contact us at:\n\nEmail: support@trade4you.co.com\nPhone: +1 (234) 567-890"
        }
    ];
